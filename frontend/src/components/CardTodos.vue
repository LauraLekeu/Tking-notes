<template>
    ...
    <div class="card-devoirs">
        ...
        <div>
            ...
            <div class="card-style-2 completed">
                <div class="card-container">
                    <div class="icon-circle">
                    ...
                    <div class="texts-content">
                        ...
                        <p class="text-content">La tâche : Lorem dolor, Lorem ipsum dolor sit amet consectetur,
                            adipisicing
                            elit. Consequatur, iusto in cum pariatur incidunt culpa at quia id qui inventore, architecto
                            deserunt? Temporibus, cumque recusandae! </p>
                    </div>
                </div>
